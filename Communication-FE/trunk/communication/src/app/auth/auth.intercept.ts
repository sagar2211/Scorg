...
export class AuthIntercept implements HttpInterceptor {
  ...
  unAuthorizedReq(): boolean {
    const unAuthorizedReq = ['login', 'display/displayList', 'forgotpassword', 'resetforgotpassword/:id', 'external/book-appointment', 'LoginThroughSSO', 'emr/patient/dynamic-chart/']; // -- give state url
