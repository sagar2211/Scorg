...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  setModuleTitleAndNav() {
    ...
    if (this.moduleName && this.moduleName === 'communication') {
      this.selectedModule.navLink = '/communicationApp';
      this.selectedModule.displayValue = 'COMMUNICATION';
    }
  ...
  getdefultLandingPageOnUserLogin(app: any) {
    // console.log(app);
    if (app.app_key === 'communication') {
      this.defaultLandingUrl = 'user';
      this.router.navigate(['/communicationApp/']);
    } else {
    ...
    // } else if (type === 'qms') {
    //   this.defaultLandingUrl = 'qms';
    //   this.router.navigate(['/app/qms/']);
    // } else if (type === 'emr') {
    //   this.defaultLandingUrl = 'emr';
    //   this.getPatientSearchData();
    //   this.router.navigate(['/app/emr/']);
