...
export class AuthService {
  ...
  setActiveAppKey(appKey) {
    sessionStorage.setItem('loginFor', JSON.stringify((appKey || 'EMR').toUpperCase()));
  }

  getActiveAppKey() {
    const appKey = JSON.parse(sessionStorage.getItem('loginFor')) || 'EMR';
  ...
  getNursingStationId(): any {
    return JSON.parse(localStorage.getItem('globals')).nursingStationId;
  }
  ...
  setNursingStationDetails(nursingStationDetails): any {
    const localData = JSON.parse(localStorage.getItem('globals'));
    localData.nursingStationId = nursingStationDetails.nursingStationId;
    localData.nursingStationName = nursingStationDetails.nursingStation;
