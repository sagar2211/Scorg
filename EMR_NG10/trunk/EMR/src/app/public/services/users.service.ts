...
export class UsersService {
  ...
  getUserDataById(userId, loginUser?): Observable<any> {
    const appId = this.authService.getAppIdByAppKey('emr');
  ...
  getUserChartComponentList(param: any): Observable<any> {
    const reqUrl = environment.dashboardBaseURL + '/PatientChart/GetUserChartComponentList/';
    return this.http.post(reqUrl, param).pipe(
      map((res: any) => {
        return res;
      })
