...
export class Constants {
  ...
  // status list for inventory purchase order
  public static purchaseOrderStatusCreated = 'Created';
  public static purchaseOrderStatusCancel = 'Cancel';
  public static purchaseOrderStatusRejected = 'Rejected';
  public static purchaseOrderStatusApproved = 'Approved';
  public static purchaseOrderStatusAmmended = 'Ammended';
  public static purchaseOrderStatusClosed = 'Closed';

  // status list for inventory indent
  public static inventoryStatusCreated = 'Raised';
  public static inventoryStatusCancel = 'Cancel';
  public static inventoryStatusRejected = 'Rejected';
  public static inventoryStatusApproved = 'Approved';
  public static inventoryStatusPartial = 'Partial';
  public static inventoryStatusComplete = 'Complete';

  // status list for inventory issue
  public static issueStatusPartiallyAccepted = 'Partially Accepted';
  public static issueStatusOpen = 'Open';
  public static issueStatusAccepted = 'Accepted';

  public static issueIndentStatusPartial = 'Partial';
  public static issueIndentStatusOpen = 'Open';
  public static issueIndentStatusComplete = 'Complete';

  public static IndentStatusRaised = 'Raised';

  // default country
  public static defaultIndiaCountryObject = {
    id: 101,
    name: 'India'
  };

  // default delivery
  public static defaultDeliveryObject = {
    id: 1,
    description: "Delivery against PO"
  };

  // default Payment
  public static defaultPaymentTermObject = {
    description: "Payment against Delivery",
    id: 1
  };

  public static auditLogStageConstants = {
    HMISView: 1,
    Master: 2,
    SupplierMaster: 3,
    ItemSupplierTax: 4,
