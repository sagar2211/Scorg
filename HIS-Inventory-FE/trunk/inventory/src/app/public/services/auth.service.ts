...
export class AuthService {
  ...
  getAuthToken(): string {
    //return JSON.parse(localStorage.getItem('globals')).auth_token;
  ...
  getUserInfoFromLocalStorage(): any {
    return this.isLoggedIn() ? JSON.parse(localStorage.getItem('globals')) : null;
  }
  ...
  getActiveAppKey() {
    return JSON.parse(sessionStorage.getItem('loginFor')) || 'INVENTORY';
  }
}
