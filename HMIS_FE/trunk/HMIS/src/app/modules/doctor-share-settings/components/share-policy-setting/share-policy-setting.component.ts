...
@Component({
  selector: 'app-share-policy-setting',
  templateUrl: './share-policy-setting.component.html',
  styleUrls: ['./share-policy-setting.component.scss']
})
export class SharePolicySettingComponent implements OnInit {
  @ViewChild(DxDataGridComponent, { static: false }) public dataGrid: DxDataGridComponent;
  referralType = 'onTotalBill';
  activeTab = 'Referral';
