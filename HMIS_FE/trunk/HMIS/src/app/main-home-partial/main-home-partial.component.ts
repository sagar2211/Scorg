...
@Component({
  selector: 'app-main-home-partial',
  templateUrl: './main-home-partial.component.html',
  styleUrls: ['./main-home-partial.component.scss']
})
export class MainHomePartialComponent implements OnInit {
