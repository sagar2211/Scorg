import { Component, OnInit, ChangeDetectionStrategy, ViewChild, TemplateRef, Input, OnDestroy, ViewContainerRef } from '@angular/core';
import { startOfDay, endOfDay, subDays, addDays, endOfMonth, isSameDay, isSameMonth, addHours, endOfWeek } from 'date-fns';
...
import { CustomDateFormatter } from 'src/app/modules/user-calendar/components/calendar/custom-date-formatter.provider';
import { CustomCalendarUtils } from 'src/app/modules/user-calendar/components/calendar/custom-calendar-utils';
...
export class CalendarComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.isPartialLink = this.router.url.indexOf('partialCalendar') !== -1;
    this.commonService.routeChanged(this.activeRoute);
    console.log('CalendarComponent:ngOnInit, isPartialLink:' + this.isPartialLink);
    if (this.isPartialLink) {
      console.log('CalendarComponent:isPartialLink');
