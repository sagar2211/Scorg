...
@Component({
  selector: 'app-display-queue-template4',
  templateUrl: './display-queue-template4.component.html',
  styleUrls: ['./display-queue-template4.component.scss']
})
export class DisplayQueueTemplate4Component implements OnInit {
  @Input() displayData;
