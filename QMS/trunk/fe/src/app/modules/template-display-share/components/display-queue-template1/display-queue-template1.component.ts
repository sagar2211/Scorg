...
@Component({
  selector: 'app-display-queue-template1',
  templateUrl: './display-queue-template1.component.html',
  styleUrls: ['./display-queue-template1.component.scss']
})
export class DisplayQueueTemplate1Component implements OnInit {
  @Input() displayData;
