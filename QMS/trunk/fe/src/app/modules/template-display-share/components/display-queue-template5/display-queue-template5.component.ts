...
@Component({
  selector: 'app-display-queue-template5',
  templateUrl: './display-queue-template5.component.html',
  styleUrls: ['./display-queue-template5.component.scss']
})
export class DisplayQueueTemplate5Component implements OnInit {
  @Input() displayData;
