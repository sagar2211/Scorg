...
export class MiniNavbarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.router.url.includes('inventory/issue/')) {
      this.hideMiniNav = true;
    } else if (this.router.url.includes('inventory/dashboard/dashboard')) {
      this.hideMiniNav = true;
    } else if (this.router.url.includes('inventory/transactions/addPurchaseOrder')) {
      this.hideMiniNav = true;
    } else if (this.router.url.includes('inventory/transactions/editPurchaseOrder')) {
      this.hideMiniNav = true;
    } else if (this.router.url.includes('inventory/transactions/addCopyPurchaseOrder')) {
      this.hideMiniNav = true;
    } else {
      this.hideMiniNav = false;
    }
  ...
  setCurrentNavAndPopup() {
    this.subscription = this.commonService.$activatedRouteChange.subscribe((obj: ActivatedRoute) => {
      ...
      if (this.router.url.includes('inventory/issue/')) {
        ...
        this.hideMiniNav = true;
      } else if (this.router.url.includes('inventory/issue/sale/salereturn/salereturn')) {
        this.hideMiniNav = true;
      } else if (this.router.url.includes('inventory/issue/patient/allsale')) {
        this.hideMiniNav = true;
      } else if (this.router.url.includes('inventory/welcome')) {
        this.hideMiniNav = true;
      } else {
        this.hideMiniNav = false;
      }
