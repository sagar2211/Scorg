...
export class ItemMaster {
  ...
  otConsumption: Unit;
  genricCode: string;
  isPostedInPatientBill: boolean;
  scheduledDrugsTypeName : string;
  ...
  generateObject(obj: any) {
    ...
    this.otConsumption = (obj.unitId || obj.purchaseUnitId) ? this.generateUnitObject(obj, 'otconsump') : null;;
    this.genricCode = obj.genricCode || null;
    this.isPostedInPatientBill = obj.isPostedInPatientBill;
    this.scheduledDrugsTypeName = obj.scheduledDrugsTypeName ? obj.scheduledDrugsTypeName : null;
  }
