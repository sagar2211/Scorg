...
@Component({
  selector: 'app-select-patient-from-account',
  templateUrl: './select-patient-from-account.component.html',
  styleUrls: ['./select-patient-from-account.component.scss']
})
export class SelectPatientFromAccountComponent implements OnInit {
  ...
  onFocusedRowChanged(evt) {
    console.log(evt);
    this.selectedPatient = evt.row.data;
  }
